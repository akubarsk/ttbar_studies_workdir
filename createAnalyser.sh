...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/work/a/akubarsk/ttbar_studies_workdir/DAnalysis_workdir/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/work/a/akubarsk/ttbar_studies_workdir/DAnalysis_workdir/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/work/a/akubarsk/ttbar_studies_workdir/DAnalysis_workdir/bin/${ananame}.cpp
