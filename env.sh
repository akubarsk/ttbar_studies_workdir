...
export LD_LIBRARY_PATH=/afs/cern.ch/work/a/akubarsk/ttbar_studies_workdir/DAnalysis_workdir:$LD_LIBRARY_PATH
export PATH=/afs/cern.ch/work/a/akubarsk/ttbar_studies_workdir/DAnalysis_workdir:$PATH
